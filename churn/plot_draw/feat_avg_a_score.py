...
title('K vs Avg score received per answer', {'fontsize':'24'})
xlabel('Number of observation posts(K)', {'fontsize':'24'})
ylabel('Avg score received per answer', {'fontsize':'24'})
fname='data/feat_avg_a_score.csv'
...
legend(prop={'size':'24'}, loc='upper right')
