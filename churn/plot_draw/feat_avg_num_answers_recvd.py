...
title('K vs Avg number of answers received per question', {'fontsize':'24'})
xlabel('Number of observation posts(K)', {'fontsize':'24'})
ylabel('Number of answers received', {'fontsize':'24'})
fname='data/feat_avg_num_answers_recvd.csv'
